      ...
      <Pressable style={styles.overlay} onPress={onClose}>
        <Pressable style={styles.modalContainer} onPress={() => {}}>
          ...
          <Column style={styles.body}>
            <NormalText
              text="Hãy chọn thời gian bạn muốn nhận hàng"
                ...
                {dateOptions.map((item, index) => (
                  <Pressable
                    ...
                    <NormalText
                      text={item}
                      style={
                        selectedDay === item ? styles.selectedText : styles.text
                      }
                    />
                  </Pressable>
                ))}
            ...
            <PrimaryButton
              title="Xác nhận"
              onPress={() => {
                const fulfillmentDateTime = calculateFulfillmentDateTime(
                  selectedDay,
                  selectedTime,
                );
...
const calculateFulfillmentDateTime = (
  selectedDay: string,
  selectedTime: string,
) => {
  const now = new Date();
