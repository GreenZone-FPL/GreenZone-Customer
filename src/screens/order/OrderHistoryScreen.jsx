...
const OrderItem = ({order, onPress}) => (
  <Pressable onPress={onPress} style={styles.orderItem}>
    ...
    <FlatList
      ...
      renderItem={({item}) => (
        <Column style={styles.productItem}>
          <Image
            source={{
              uri: 'https://www.onicifood.com/cdn/shop/products/332594556_3485601318363625_7384526670140317642_n.png?v=1677766982&width=1445',
            }}
    ...
    <Row style={{alignItems: 'flex-start', justifyContent: 'space-between'}}>
      <NormalText style={{color: colors.gray850}} text={order.createdAt} />
