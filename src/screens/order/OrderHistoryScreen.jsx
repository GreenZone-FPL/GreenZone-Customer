    ...
    <FlatList
      ...
      renderItem={({item}) => (
        <View style={styles.productItem}>
          <Image
            source={{
              uri: 'https://static.vecteezy.com/system/resources/previews/019/199/710/non_2x/bubble-milk-tea-pearl-milk-tea-png.png',
            }}
    ...
    {order.estimatedTime && (
      <View style={styles.column}>
        ...
        <Text style={styles.estimatedTime}>
          Dự kiến đến nơi vào {order.estimatedTime} hôm nay
        </Text>
      </View>
    )}
  </Pressable>
